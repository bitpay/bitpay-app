...
const SellCrypto = ({disabled = false}) => {
  const theme = useTheme();
  const disabledCircleColor = theme.dark ? DisabledDark : Disabled;
  const disabledIconColor = theme.dark ? '#757575' : '#BDBDBD';
  ...
  return (
    <Svg.Svg width="44" height="44" viewBox="0 0 44 44" fill="none">
      <Svg.Rect
        ...
        height="44"
        rx="11"
        fill={disabled ? disabledCircleColor : theme.dark ? Midnight : Action}
      />
      <Svg.Path
        fill={disabled ? disabledIconColor : theme.dark ? '#4989FF' : White}
...
const BuyGiftCard = ({disabled = false}) => {
  ...
  return (
    <Svg.Svg width="46" height="46" viewBox="0 0 46 46" fill="none">
      <Svg.Circle cx="22.6449" cy="22.6449" r="22.6449" fill={fillColor} />
      <Svg.Path
        fill={iconColor}
        fillRule="evenodd"
        clipRule="evenodd"
...
const Exchange = ({disabled = false}) => {
  const theme = useTheme();
  const circleColor = theme.dark ? Midnight : Action;
  const iconColor = theme.dark ? '#4989FF' : White;
  ...
  return (
    <Svg.Svg width="46" height="46" viewBox="0 0 46 46" fill="none">
      <Svg.Circle
        ...
        cy="22.6449"
        r="22.6449"
        fill={disabled ? disabledCircleColor : circleColor}
      />
      <Svg.Path
        fill={disabled ? disabledIconColor : iconColor}
