        ...
        onPress={() => {
          ...
          dispatch(
            openUrlWithInAppBrowser(
              'https://support.rampnetwork/en/articles/10415-what-fees-does-ramp-charge-for-buying-and-selling-crypto',
            ),
          );
        }}>
      ...
      <TouchableOpacity
        onPress={() => {
          ...
          dispatch(
            openUrlWithInAppBrowser(
              country == 'US'
                ? 'https://rampnetwork/terms-of-service/#us-terms-of-service'
                : 'https://rampnetwork/terms-of-service/#global-terms-of-service',
            ),
          );
        }}>
