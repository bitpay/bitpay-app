...
export interface RampPaymentUrlConfigParams {
  ...
  // swapAmount(number): the amount should be provided in wei or token units. You can block editing value of the transaction by providing swapAmount and single swapAsset parameters e.g. https://buy.rampnetwork/?swapAmount=100000000000000000&swapAsset=ETH for 0.1 ETH
