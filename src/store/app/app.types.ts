...
export enum AppActionTypes {
  ...
  SET_MIGRATION_SENSITIVE_STORAGE_COMPLETE = 'APP/SET_MIGRATION_SENSITIVE_STORAGE_COMPLETE',
  SET_KEY_MIGRATION_SENSITIVE_STORAGE_FAILURE = 'APP/SET_KEY_MIGRATION_SENSITIVE_STORAGE_FAILURE',
...
interface SetMigrationSensitiveStorageComplete {
  type: typeof AppActionTypes.SET_MIGRATION_SENSITIVE_STORAGE_COMPLETE;
}

interface SetKeyMigrationSensitiveStorageFailure {
  type: typeof AppActionTypes.SET_KEY_MIGRATION_SENSITIVE_STORAGE_FAILURE;
}
...
export type AppActionType =
  ...
  | SetKeyMigrationSensitiveStorageFailure
