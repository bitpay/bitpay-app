  ...
  return (
    <Svg.Svg width={size} height={size} viewBox="0 0 41 40" fill="none">
      <Svg.Path
        ...
        fill={theme.dark ? '#393939' : Slate30}
      />
      <Svg.Path
        ...
        fill={theme.dark ? Slate : SlateDark}
      />
    </Svg.Svg>
  );
};
  ...
  return (
    <Svg.Svg width={size} height={size} viewBox="0 0 40 40" fill="none">
      <Svg.Path
        ...
        fill={
          backgroundColor ? backgroundColor : theme.dark ? '#393939' : Slate30
        }
      />
      <Svg.Path
        fillRule="evenodd"
        ...
        fill={mainColor ? mainColor : theme.dark ? Slate : SlateDark}
      />
    </Svg.Svg>
  );
};

export const TxSellIcon = ({size = TRANSACTION_ICON_SIZE}: TxIconProps) => {
  ...
  return (
    <Svg.Svg width={size} height={size} viewBox="0 0 40 40" fill="none">
      ...
      <Svg.Line
        ...
        x2="17.0591"
        y2="25.1323"
        stroke={theme.dark ? Slate : SlateDark}
        stroke-width="1.5"
...
export const TransactionIcons: {[index in string]: ReactElement} = {
  ...
  moonpay: (
    <SellTxIcon width={TRANSACTION_ICON_SIZE} height={TRANSACTION_ICON_SIZE}>
      <TxSellIcon size={TRANSACTION_ICON_SIZE} />
      <SellTxIconBadge>
        <TxSentIcon size={14} backgroundColor={'#FF647C'} mainColor={White} />
      </SellTxIconBadge>
    </SellTxIcon>
  ),
  oneInch: (
