...
export const SupportedTokenOptions: Array<SupportedCurrencyOption> = [
  {
    ...
    tokenAddress: '0x4fabb145d64652a948d72533023f6e7a623c7c53_e',
  },
  {
    id: Math.random().toString(),
    ...
    badgeSrc: require('../../assets/img/currencies/png/ETH.png'),
    badgeUri: CurrencyListIcons.eth,
    tokenAddress: '0x8e870d67f660d95d5be530380d0ec0bd388289e1_e',
  },
  {
    id: Math.random().toString(),
    ...
    badgeSrc: require('../../assets/img/currencies/png/ETH.png'),
    badgeUri: CurrencyListIcons.eth,
    tokenAddress: '0xa0b86991c6218b36c1d19d4a2e9eb0ce3606eb48_e',
  },
  {
    id: Math.random().toString(),
    ...
    badgeSrc: require('../../assets/img/currencies/png/ETH.png'),
    badgeUri: CurrencyListIcons.eth,
    tokenAddress: '0x056fd409e1d7a124bd7017459dfea2f387b6d5cd_e',
  },
  {
    id: Math.random().toString(),
    ...
    badgeSrc: require('../../assets/img/currencies/png/ETH.png'),
    badgeUri: CurrencyListIcons.eth,
    tokenAddress: '0x6b175474e89094c44da98b954eedeac495271d0f_e',
  },
  {
    id: Math.random().toString(),
    ...
    badgeSrc: require('../../assets/img/currencies/png/ETH.png'),
    badgeUri: CurrencyListIcons.eth,
    tokenAddress: '0x2260fac5e5542a773aa44fbcfedf7c193bc2c599_e',
  },
  {
    id: Math.random().toString(),
    ...
    badgeSrc: require('../../assets/img/currencies/png/ETH.png'),
    badgeUri: CurrencyListIcons.eth,
    tokenAddress: '0x95ad61b0a150d79219dcf64e1e6cc01f0b64c4ce_e',
  },
  {
    id: Math.random().toString(),
    ...
    badgeSrc: require('../../assets/img/currencies/png/ETH.png'),
    badgeUri: CurrencyListIcons.eth,
    tokenAddress: '0x4d224452801ACEd8B2F0aebE155379bb5D594381_e',
  },
  {
    id: Math.random().toString(),
    ...
    badgeSrc: require('../../assets/img/currencies/png/ETH.png'),
    badgeUri: CurrencyListIcons.eth,
    tokenAddress: '0x1aBaEA1f7C830bD89Acc67eC4af516284b1bC33c_e',
  },
  {
    id: Math.random().toString(),
    ...
    tokenAddress: '0x7d1afa7b718fb893db30a3abc0cfc608aacfebb0_e',
  },
  {
    id: Math.random().toString(),
    ...
    badgeUri: CurrencyListIcons.matic,
    tokenAddress: '0xdab529f40e671a1d4bf91361c21bf9f0c9712ab7_m',
  },
  {
    id: Math.random().toString(),
    ...
    badgeSrc: require('../../assets/img/currencies/png/MATIC.png'),
    badgeUri: CurrencyListIcons.matic,
    tokenAddress: '0x2791bca1f2de4661ed88a30c99a7a9449aa84174_m',
  },
  {
    id: Math.random().toString(),
    ...
    badgeSrc: require('../../assets/img/currencies/png/MATIC.png'),
    badgeUri: CurrencyListIcons.matic,
    tokenAddress: '0x8f3cf7ad23cd3cadbd9735aff958023239c6a063_m',
  },
  {
    id: Math.random().toString(),
    ...
    badgeSrc: require('../../assets/img/currencies/png/MATIC.png'),
    badgeUri: CurrencyListIcons.matic,
    tokenAddress: '0x1bfd67037b42cf73acf2047067bd4f2c47d9bfd6_m',
  },
  {
    id: Math.random().toString(),
    ...
    badgeSrc: require('../../assets/img/currencies/png/MATIC.png'),
    badgeUri: CurrencyListIcons.matic,
    tokenAddress: '0x6f8a06447ff6fcf75d803135a7de15ce88c1d4ec_m',
  },
  {
    id: Math.random().toString(),
    ...
    badgeSrc: require('../../assets/img/currencies/png/MATIC.png'),
    badgeUri: CurrencyListIcons.matic,
    tokenAddress: '0xb7b31a6bc18e48888545ce79e83e06003be70930_m',
  },
];
